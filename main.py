...
def main(image_path):
    ...
    os.system(f'python -m simple_test -r 256 --use_rect -i {image_dir}')

    return os.path.join(os.getcwd(), "results/pifuhd_final/recon/result_Img_256.obj")


if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    # parser.add_argument('--checkpoint-path', type=str, required=True, help='path to the checkpoint')
    parser.add_argument('--img', type=str,  default="vid2avtar1.jpg", help='path to the image')
    args = parser.parse_args()

    print(f"Obj file created at {main(args.img)}")
